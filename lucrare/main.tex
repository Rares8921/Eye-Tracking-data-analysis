...
\usepackage{enumitem}
\setlist[itemize]{topsep=0.2em,itemsep=0.15em,parsep=0pt,partopsep=0pt}

% Metadate
\title{Analiza și modelarea datelor colectate prin eye-tracking}
\author{Cocoșilă-Dumitriu Rareș}
